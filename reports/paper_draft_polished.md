...
To provide a comprehensive overview of our empirical findings, Table 4.1 maps every model, level of analysis, and key parameter estimated across our state-level and district-level specifications. We then present these findings in detail, leading with the ESEA waiver compliance commitment results.
